...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_GL {
            ...
            when DEBUG { foreign import sokol_app_clib { "../sokol_dll_windows_x64_gles_debug.lib" } }
            else       { foreign import sokol_app_clib { "../sokol_dll_windows_x64_gles_release.lib" } }
        } else {
        ...
        when USE_GL {
            ...
            when DEBUG { foreign import sokol_app_clib { "sokol_app_windows_x64_gles_debug.lib" } }
            else       { foreign import sokol_app_clib { "sokol_app_windows_x64_gles_release.lib" } }
        } else {
